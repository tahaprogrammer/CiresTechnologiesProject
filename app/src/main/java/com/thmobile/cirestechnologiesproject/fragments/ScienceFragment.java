...
public class ScienceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerViewScience);
        ...
        if (Utils.dataModels_Science.isEmpty()) {
            ...
            dataRequestServer.getAllOnlineData(Utils.BASE_URL_Science, new OnDownloadFinished() {
                ...
                public void onFinished(ArrayList<DataModel> dataModels) {
                    ...
                    Utils.dataModels_Science = dataModels;
                }
            });
        }else{
            listAdapter.updateList(Utils.dataModels_Science);
        }
